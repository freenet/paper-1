...
\paragraph{Content-addressed storage.} The original Freenet \citep{clarke2001freenet} and IPFS \citep{benet2014ipfs} provide name-by-hash access to immutable data. Applications must add their own mechanisms for mutable state. Chat rooms, document editors, and social feeds consequently implement consistency independently, often with different behavior across clients.
