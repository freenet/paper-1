...
\input{figures/peer-architecture.tex}
...
\begin{description}[leftmargin=1.4em, style=nextline, itemsep=2pt]
  ...
  \item[\textsf{UPDATE}] Submit an update to a contract. The update is merged into existing replicas using the contract's merge function and propagated through the mesh of neighboring co-hosts.
